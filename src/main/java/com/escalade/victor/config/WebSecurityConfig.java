...
//                .antMatchers("/edition/**", "/details/**","/save/**","/add/**").permitAll()
                ...
                .antMatchers("/reservation/editionReservation/**", "/reservation/detailsReservation/**","/reservation/saveTopoReservation/**","/reservation/addTopoReservation/**","/reservation/listReservation/**").permitAll()
                ...
                .antMatchers("/reservation/listReservationByUser/**","/reservation/makeTopoAccepte/**","/topologie/listTopologieDifferentByUser/**").permitAll()
                .antMatchers("/topologie/listTopologiePublic/**","/topologie/makeTopoPublic/**","/reservation/addTopoReservation/**").permitAll()
