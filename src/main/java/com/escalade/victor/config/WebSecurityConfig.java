...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/reservation/editionReservation/**", "/reservation/detailsReservation/**","/reservation/saveTopoReservation/**","/topologie/addTopoReservation/**","/reservation/listReservation/**").permitAll()
                ...
                .antMatchers("/topologie/listTopologiePublic/**").permitAll()
                ...
                .antMatchers("/","/topologie/SearchTopoList/**","/commentaire/deleteCommentaire/**","/topologie/SearchSiteList/**","/topologie/SearchVoieList/**").permitAll()
                .antMatchers("/commentaire/deleteCommentaire/**","/topologie/SearchSiteList/**","/topologie/SearchVoieList/**").permitAll()
                .antMatchers("/site/**","/topologie/**","/commentaire/**","/voie/**","/user/home/**").hasAuthority("ADMIN")
                .antMatchers("/admin/**","/commentaire/saveCommentaire/**","/commentaire/addCommentaire/**","/commentaire/editionCommentaire/**","/commentaire/deleteCommentaire/**").hasAuthority("ADMIN") //
